...
namespace Renci.SshNet.Security
{
    ...
    public abstract class KeyExchangeDiffieHellmanGroupSha1 : KeyExchangeDiffieHellman
    {
        ...
        {
            var hashData = new ExchangeHashData
                {
        ...
        public override void Start(Session session, KeyExchangeInitMessage message)
        {
            ...
            Group = new BigInteger(new byte[] { 2 });

            PopulateClientExchangeValue();

            SendMessage(new KeyExchangeDhInitMessage(ClientExchangeValue));
        ...
        private class ExchangeHashData : SshData
        {
